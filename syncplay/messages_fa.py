...
fa = {
    ...
    "reconnection-attempt-notification": "ارتباط با سرور قطع شد. در حال برقراری اتصال",
    "disconnection-notification": "اتصال با سرور قطع شد",
    "connection-failed-notification": "ارتباط با سرور قطع شد",
    "connected-successful-notification": "با موفقیت به سرور وصل شدید",
    ...
    # Client labels
    "config-window-title": "BaHamBin (باهمبین)",
    ...
    "never-rewind-value": "هرگز",
    "seconds-suffix": " secs",
    "privacy-sendraw-option": "به صورت کامل بفرست",
    "privacy-sendhashed-option": "به صورت رمزی بفرست",
    "privacy-dontsend-option": "نفرست",
    "filename-privacy-label": "اطلاعات اسم فایل رو",
    "filesize-privacy-label": "اطلاعات حجم فایل رو",
    "checkforupdatesautomatically-label": "به صورت خودکار بروزرسانی را چک کن",
    "slowondesync-label": "به مقدار خیلی کمی فیلم را آهسته کن",
    "rewindondesync-label": "بازبینی صحنه (پیشنهادی)",
    "fastforwardondesync-label": "سریع فیلمو به جلو ببر (پیشنهادی)",
    ...
    "forceguiprompt-label": "همیشه این پنجره رو نمایش نده",  # (Inverted)
    "showosd-label": "فعال بودن پیام های روی فیلم",

    "showosdwarnings-label": "شامل اخطار ها",
    "showsameroomosd-label": "شامل اتفاقات داخل اتاق",
    "shownoncontrollerosd-label": "شامل اتفاقات افراد معمولی در اتاق های مدیریت شده",
    "showdifferentroomosd-label": "شامل اتفاقات اتاق های دیگر",
    "showslowdownosd-label": "شامل خبر کم شدن سرعت پخش و دوباره پخش شدن",
    "language-label": "<- زبان بزنامه",
    "automatic-language": "Default ({})",  # Default language
    "showdurationnotification-label": "بابت تفاوت زمان فیلم اخطار بده",
    "basics-label": "صفحه اصلی",
    "readiness-label": "پخش و توقف",
    "misc-label": "تنظیمات دیگر",
    ...
    "unpause-always": "همیشه ادامه ی فیلم پخش شه",
    "syncplay-trusteddomains-title": "دامنه های قابل اطمینان:",

    "chat-title": "ورودی چت",
    "chatinputenabled-label": "mpv فعال بودن ورودی چت در",
    "chatdirectinput-label": "Enter فعال بودن چت مستقیم با فشار دادن دکمه ی",
    "chatinputfont-label": "فونت چت ورودی",
    "chatfont-label": "فونت",
    "chatcolour-label": "رنگ",
    "chatinputposition-label": "mpv محل چت ورودی در",
    "chat-top-option": "بالا",
    "chat-middle-option": "وسط",
    "chat-bottom-option": "پایین",
    "chatoutputheader-label": "خروجی چت",
    "chatoutputfont-label": "فونت چت خروجی",
    "chatoutputenabled-label": "فعال بودن خروجی چت (فقط در ام پی وی)",
    "chatoutputposition-label": "<- مدل",
    "chat-chatroom-option": "چت رومی",
    "chat-scrolling-option": "لیستی",
